...
async def main():
    """Run a conversation demo with session management."""
...
if __name__ == "__main__":
    print("""
╔═══════════════════════════════════════════════════════════╗
║  Session Management Demo - Stateful Conversations         ║
╚═══════════════════════════════════════════════════════════╝

This example demonstrates:
- Creating sessions with InMemorySessionService
- Maintaining conversation context across multiple turns
- Agent remembering information from earlier in the chat
